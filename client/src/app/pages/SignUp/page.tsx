                ...
                <div className="signup-promo-section">
                    <div className="promo-content">
                        ...
                        <p className="promo-description">
                            ...
                            manage orders efficiently, and grow their business with powerful analytics and insights.
                        </p>
                            ...
                            <div className="feature-item">
                                <div className="feature-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <path d="M13.73 21A2 2 0 0 1 12 23A2 2 0 0 1 10.27 21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                </div>
                                <div className="feature-text">
                                ...
                                <div className="password-input-wrapper">
                                    ...
                                    >
                                        {showPassword ? (
                                            ...
                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                                                <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20C7 20 2 17 2 12C2 7 7 4 12 4C17 4 22 7 22 12C22 17 20.94 17.94 17.94 17.94Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
